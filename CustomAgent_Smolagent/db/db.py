...
#def log_feedback(file_id: int, source: str, is_accepted: bool, comments: str) -> None:
#    """Insert a feedback record."""
#    with connect() as conn:
#        conn.execute(
#            "INSERT INTO feedback (file_id, source, is_accepted, comments) VALUES (?,?,?,?)",
#            (file_id, source, is_accepted, comments),
#        )
